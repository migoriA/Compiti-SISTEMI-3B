...
void loadVet(int vet[]){
    int ver[90]; //check if the number is present in the array
    int exit=0; //this flag is f
    int rand;
...
void play(int cart1[],int cart2[],int cart3[],int cart4[],char name1[],char name2[],char name3[],char name4[]){
    ...
    while(tombola == 0){
        do{
            numeroEstratto=randomNumber(1,90);
